 ...
 * Shows conversations from followed users
 */
...
import { ArrowLeft, Edit, Users, Inbox } from "lucide-react-native";
...
export default function MessagesInboxScreen() {
  ...
  const loadConversations = useCallback(async () => {
    try {
      const inboxConvs = await messagesApiClient.getFilteredConversations("primary");
      const transformed = inboxConvs
      ...
      >
        ...
        {conversations.length === 0 && (
          <EmptyState
            icon={Inbox}
            title="No Messages"
            description="Messages from people you follow will appear here"
            action={
