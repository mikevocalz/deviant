...
const textColors = ["#ffffff", "#000000", "#FF5BFC", "#3EA4E5", "#38ef7d", "#f7b733"]
...
export default function CreateStoryScreen() {
  ...
  const handleMediaSelected = useCallback((media: MediaAsset[]) => {
  ...
  return (
    <SafeAreaView edges={["top"]} style={{ flex: 1, backgroundColor: "#000" }}>
      <View style={{ 
        ...
        <Text style={{ fontSize: 18, fontWeight: "700", color: "#fff" }}>Create Story</Text>
        <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
          <Pressable
            onPress={handleShare}
            disabled={isSharing || (selectedMedia.length === 0 && !text)}
            style={{
              backgroundColor: selectedMedia.length > 0 || text ? "#3EA4E5" : "#1a1a1a",
              paddingHorizontal: 16,
              paddingVertical: 8,
              borderRadius: 20,
          ...
          >
            <Text
              style={{
                fontWeight: "600",
                color: selectedMedia.length > 0 || text ? "#fff" : "#666",
                fontSize: 14,
              }}
            >
      ...
      <View style={{ paddingHorizontal: 16, paddingBottom: 16 }}>
        <View style={{ flexDirection: "row", justifyContent: "center", gap: 24, marginBottom: 16 }}>
          ...
          >
            ...
            <Text style={{ color: "#999", fontSize: 12 }}>
              Photo {mediaAssets.length > 0 ? `(${mediaAssets.length}/${MAX_STORY_ITEMS})` : ""}
            </Text>
          </Pressable>
        ...
        {selectedMedia.length === 0 && (
          <>
            <Text style={{ color: "#666", fontSize: 12, marginBottom: 8, marginLeft: 4 }}>Background</Text>
            ...
            {(showTextInput || text) && (
              <>
                <Text style={{ color: "#666", fontSize: 12, marginTop: 16, marginBottom: 8, marginLeft: 4 }}>
                  Text Color
                </Text>
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                  <View style={{ flexDirection: "row", gap: 10 }}>
                    {textColors.map((color, index) => (
                      <Pressable
                        ...
                        style={{
                          ...
                          borderColor: index === activeTextColorIndex ? "#3EA4E5" : "#333",
                        }}
                      />
                    ))}
                  </View>
