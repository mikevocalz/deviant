...
import { LegendList, type LegendListRenderItemProps } from "@/components/list";
import { AppTrace } from "@/lib/diagnostics/app-trace";
import type { CartLineItem, LineItemCategory } from "@/lib/contracts/dto";
import { calculateCartSubtotalCents } from "@/lib/contracts/invariants";
import { useMixedCartCheckout } from "@/lib/hooks/use-mixed-cart-checkout";
import { computeFees, formatCents } from "@/lib/stripe/fee-calculator";
