...
const TEST_TICKET: Ticket = {
  ...
  status: "valid",
  qrToken:
    "eyJ0aWQiOiJ0a3RfMjAyNTAxMTMwMDAwMSIsImVpZCI6Imxvd2VyLWVhc3Qtc2lkZS13aW50ZXItYmFyLWZlc3QifQ",
  qrSvg: QR_SVG,
  tier: "vip",
  tierName: "VIP Access",
  transferable: true,
  ...
  doorPolicy: "21+ with valid ID",
  entryWindow: "10:00 PM – 12:00 AM",
  perks: ["Priority entry", "Complimentary drink", "VIP lounge access"],
};
